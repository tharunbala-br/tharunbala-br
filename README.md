...
![Location](https://img.shields.io/badge/Location-Chennai%2C%20India-0D1117?style=flat-square&labelColor=0D1117&color=4FA8D8)
![Education](https://img.shields.io/badge/B.Tech-Mechanical%20Engineering%20%40%20VIT-0D1117?style=flat-square&labelColor=0D1117&color=4FA8D8)
...
DOMAIN   =  Manufacturing | Industrial Automation | Automotive Components
STACK    =  Siemens S7-1200 (TIA Portal) | Python | SolidWorks | ANSYS | Webots
OPEN_TO  =  Manufacturing Engineer / Automation Engineer / GET roles
```
...
Fault-detection system for bearing faults, imbalance, and shaft misalignment using vibration and sensor data, with ML applied to flag early-stage equipment degradation.
...
<details>
<summary><b>&#9654; Autonomous Mobile Robot Navigation Simulation</b></summary>
<br>

Simulation framework evaluating a differential-drive mobile robot's indoor navigation across corridors, office layouts, and obstacle-rich workspaces of varying complexity.

| Aspect | Detail |
| :-- | :-- |
| **Role** | Team Lead & Lead Author (5-member team) |
| **Stack** | Webots &middot; Python &middot; Path Planning |
| **Metrics** | Mission completion time &middot; path length &middot; collision count &middot; success rate |
| **Outcome** | Research paper (lead author, in preparation); selected to present at **iTMD 2026, NIT Jalandhar** (Track 3: Design) |

</details>

<details>
<summary><b>&#9654; Surface Engineering Research — Oxidation-Resistant Ni&ndash;P/Al Coatings on Brass</b></summary>
<br>

Palladium-free electroless Ni&ndash;P/Al coating process on brass: FeCl&#8323; micro-texturing &rarr; electrochemical Ni seeding (Pt anode) &rarr; electroless Ni&ndash;P deposition &rarr; Al incorporation, characterized across six sample conditions.
...
`15 – 25 June 2026`
- Completed a 2-week Industrial Mechatronics programme using MTAB (Siemens Centre of Excellence, Dept. of Instrumentation Engineering); secured **A+ grade (89%)**
- Programmed and validated PLC-based control sequences using Siemens S7-1200 and TIA Portal
- Developed Ladder Logic for conveyor, sensor, and actuator-based automation

`Tags: PLC | Siemens S7-1200 | TIA Portal | Ladder Logic`

**Industrial Intern** — Wheels India Limited (TVS Group), Padi, Chennai
`03 June – 03 July 2025`
- Studied manufacturing operations across casting, forging, machining, and assembly
- Reviewed BOM and assembly documentation against production requirements
- Collaborated with Production, Quality, and Planning teams on workflow analysis

`Tags: Manufacturing Processes | BOM Review | Process Optimization`
...
- Bharatiya Antariksh Hackathon 2026 — ISRO & Hack2skill, Certificate of Participation
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/tharunbala-br/tharunbala-br/output/github-contribution-grid-snake-dark.svg" />
  <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/tharunbala-br/tharunbala-br/output/github-contribution-grid-snake.svg" />
  <img alt="contribution snake animation" src="https://raw.githubusercontent.com/tharunbala-br/tharunbala-br/output/github-contribution-grid-snake.svg" />
</picture>

</div>

> Set up steps for this widget are below — it needs a one-time GitHub Action added to this repo (instructions after the file).
...
```yaml
learning:
  - Advanced GD&T and tolerance stacking
  - Applied ML for predictive maintenance in manufacturing

building:
  - Ni-P/Al coating research paper       # oxidation-resistant coatings on brass
  - AMR navigation research paper        # for iTMD 2026, NIT Jalandhar
  - Patent draft                         # FeCl3 micro-texturing solution

open_to:
  - Graduate Engineer Trainee / Manufacturing Engineer roles
  - Automation & PLC-focused roles in automotive component manufacturing
```
